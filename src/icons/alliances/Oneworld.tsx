const Oneworld = () => (
  <svg viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
    ...
    <g transform="matrix(.40160643 0 0 .40160643 -.40160643 -.40160643)">
      <circle cx="250" cy="250" fill="#5752a6" r="249" />
      <circle cx="250" cy="250" fill="url(#a)" r="249" />
      <circle cx="250" cy="250" fill="url(#b)" r="249" />
      <circle cx="250" cy="250" fill="url(#c)" r="249" />
      <circle cx="250" cy="250" fill="url(#d)" r="249" />
      <circle cx="250" cy="250" fill="url(#e)" r="249" />
      <path
        clip-rule="evenodd"
        d="m53.337 285.563c17.191 0 30.249-9.493 30.249-29.853 0-20.12-12.945-29.594-30.249-29.594-15.451 0-30.256 7.82-30.256 29.594 0 20.36 13.057 29.853 30.256 29.853m0-13.04c-10.55 0-11.713-10.439-11.713-16.796 0-15.83 8.397-16.605 11.713-16.605 3.704 0 11.705.775 11.705 16.605 0 6.237-.964 16.796-11.705 16.796"
        fill="#fff"
        fill-rule="evenodd"
      />
      <path
        clip-rule="evenodd"
        d="m109.407 228.167h-16.58v55.295h17.269v-28.578c0-2.395.215-15.142 11.576-15.142 9.207 0 9.767 8.82 9.767 14.263v29.457h17.252v-34.728c0-20.568-11.464-22.618-19.292-22.618-7.726 0-15.332 2.601-19.991 8.699"
        fill="#fff"
        fill-rule="evenodd"
      />
      <path
        clip-rule="evenodd"
        d="m198.576 267.459c-1.413 4.909-5.151 5.701-9.948 5.701-10.335 0-12.316-7.976-12.419-13.298h41.591l-.104-3.066c-.215-6.752-1.645-30.679-28.525-30.679-18.061 0-31.006 10.439-31.006 29.594 0 28.198 22.419 29.853 29.706 29.853 10.232 0 24.374-2.429 28.732-18.104m-40.395-16.865c.319-5.667 2.963-12.971 12.755-12.971 4.022 0 10.155 1.12 10.37 12.971z"
        fill="#fff"
        fill-rule="evenodd"
      />
      <polyline
      ...
      <path
        clip-rule="evenodd"
        d="m304.194 255.814c0 16.434 7.425 29.853 25.976 29.853 18.501 0 25.942-13.419 25.942-29.853 0-16.417-7.441-29.818-25.942-29.818-18.551 0-25.976 13.401-25.976 29.818m5.099 0c0-15.659 6.787-25.994 20.877-25.994 14.057 0 20.844 10.335 20.844 25.994 0 15.675-6.787 26.011-20.844 26.011-14.09 0-20.877-10.336-20.877-26.011"
        fill="#fff"
        fill-rule="evenodd"
      />
      <path
        clip-rule="evenodd"
        d="m394.318 227.099h-2.566c-9.25 0-16.277 5.65-18.965 12.506h-.207v-11.438h-4.926v55.295h4.926v-26.442c0-22.428 12.023-24.805 19.292-25.029h2.446"
        fill="#fff"
        fill-rule="evenodd"
      />
      <rect
